...
class Kobby:
    ...
    def __init__(self):
        ...
        if Kobby.sound == None:
            self.suction_sound = load_wav('./resource/suction.wav')
            self.suction2_sound = load_wav('./resource/suction2.wav')
            self.jump_sound = load_wav('./resource/jump.wav')
            self.air_sound = load_wav('./resource/air.wav')
            self.star_sound = load_wav('./resource/star.wav')
            self.hit_sound_1 = load_wav('./resource/hit2.wav')
            self.hit_sound_2 = load_wav('./resource/hit3.wav')
            self.hit_sound_3 = load_wav('./resource/hit4.wav')
            self.hit_sound_4 = load_wav('./resource/hit5.wav')
            self.ice_sound = load_wav('./resource/ice.wav')
            self.balloon_sound = load_wav('./resource/balloon1.wav')
            self.run_sound = load_wav('./resource/run.wav')
            self.magic_sound= load_wav('./resource/magic.wav')
            self.sword_sound = load_wav('./resource/sword.wav')
            self.sword2_sound = load_wav('./resource/sword2.wav')
            self.fire_sound = load_wav('./resource/fire2.wav')
            self.fire2_sound = load_wav('./resource/fire.wav')
            self.walk_sound = load_wav('./resource/walk.wav')
            self.change_sound = load_wav('./resource/change.wav')
            self.walking_sound = load_wav('./resource/walking.wav')
        ...
        if Kobby.first == None:
            self.image=load_image('./resource/nomal_kobby_sheet.png')
            self.image1_1=load_image('./resource/nomal_kobby_sheet2.png')
            self.image1_2 = load_image('./resource/big_kobby_sheet.png')
            self.image2=load_image('./resource/magic_kobby_sheet.png')
            self.image2_1 = load_image('./resource/magic_kobby_sheet2.png')
            self.image3=load_image('./resource/sword_kobby_sheet.png')
            self.image3_1 = load_image('./resource/sword_kobby_sheet2.png')
            self.image4=load_image('./resource/ice_kobby_sheet.png')
            self.image4_1 = load_image('./resource/ice_kobby_sheet2.png')
            self.image5=load_image('./resource/fire_kobby_sheet.png')
            self.image5_1 = load_image('./resource/fire_kobby_sheet2.png')
            self.hurt_image = load_image('./resource/kobby_hurt_sheet.png')
            self.hp_image1 = load_image('./resource/hpUI1.png')
            self.hp_image2 = load_image('./resource/hpUI2.png')
            self.hp_image3 = load_image('./resource/hpUI3.png')
            self.icon_image = load_image('./resource/heart_icon1.png')
            self.icon_image2 = load_image('./resource/heart_icon2.png')
            self.icon_image3 = load_image('./resource/heart_icon3.png')
            self.effect_image = load_image('./resource/effect.png')
