...
class Ground:
    def __init__(self, object, stage = 1):
        # 스테이지 1
        self.image1 = load_image('./resource/ground1.png')
        self.image2 = load_image('./resource/ground1_grass.png')
        self.image3 = load_image('./resource/ground_grass2.png')
        self.image4 = load_image('./resource/ground_grass3.png')
        self.image5 = load_image('./resource/ground_grass4.png')
        # 스테이지 2
        self.image6 = load_image('./resource/ground2.png')
        self.image7 = load_image('./resource/ground2_1.png')
        self.image8 = load_image('./resource/ground2_2.png')
        self.image9 = load_image('./resource/ground2_3.png')
        # 스테이지 3
        self.image22 = load_image('./resource/stage3.png')
        self.image23 = load_image('./resource/stage3_2.png')
        # 스테이즈  - 보스 -
        self.image10 = load_image('./resource/boss_stage_1.png')
        self.image11 = load_image('./resource/boss_stage_2.png')
        self.image12 = load_image('./resource/boss_stage_3.png')
        self.image13 = load_image('./resource/boss_stage_4.png')
        self.image14 = load_image('./resource/boss_stage_5.png')
        self.image15 = load_image('./resource/boss_stage_6.png')
        self.image16 = load_image('./resource/boss_stage_7.png')
        self.image17 = load_image('./resource/boss_stage_8.png')
        self.image18 = load_image('./resource/boss_stage_9.png')
        self.image19 = load_image('./resource/boss_stage_10.png')
        self.image20 = load_image('./resource/boss_stage_11.png')
        self.image21 = load_image('./resource/boss_stage_12.png')
        self.bgm1 = load_music('./resource/stage1.mp3')
        self.bgm1.set_volume(10)
        self.bgm2 = load_music('./resource/stage2.mp3')
        self.bgm2.set_volume(10)
        self.bgm3 = load_music('./resource/stage3.mp3')
        self.bgm3.set_volume(10)
        self.bgm4 = load_music('./resource/boss_stage.mp3')
        self.bgm4.set_volume(10)
